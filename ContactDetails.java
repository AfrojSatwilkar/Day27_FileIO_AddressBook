...
public class ContactDetails {
    ...
    ArrayList<AddressBook> personList = new ArrayList<>();
    Map<String,ArrayList<AddressBook>> addressBook = new HashMap<String, ArrayList<AddressBook>>();
    ...
    public void editDetails() {
        ...
        if (index!=personList.size()) {
            AddressBook details = personList.get(index);
    ...
    public void showDetails() {
        int index = searchName();
        if (index!=personList.size()) {
            AddressBook person = personList.get(index);
